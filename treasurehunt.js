...
const treasure = (location) =>{
    if(location == treasureLocation){
      document.getElementById('table').innerHTML = "<br>" + "You win!!!" + "<br>" + "<br>" + '<img src="https://www.pikpng.com/pngl/m/589-5899241_chocolate-easter-bunny-clipart.png" height= "300px"/>'
    }
