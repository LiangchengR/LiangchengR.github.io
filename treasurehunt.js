...
const treasure = (location) =>{
    if(location == treasureLocation){
      document.getElementById('table').innerHTML = "<br>" + "You win!!!" + "<br>" + "<br>" + '<img src="https://www.maxpixel.net/static/photo/2x/Tracy-Sweetness-Easter-Theme-Chocolate-Easter-Bunny-3223851.png" height= "300px"/>'
    }
