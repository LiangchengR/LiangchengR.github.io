...
const treasure = (location) =>{
    if(location == treasureLocation){
      document.getElementById('table').innerHTML = "<br>" + "You win!!!" + "<br>"+ '<img src="https://cdn.pixabay.com/photo/2018/03/13/22/05/easter-bunny-3223851_960_720.png" height= "300px"/>'
    }
